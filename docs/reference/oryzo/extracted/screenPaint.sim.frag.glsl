// ============================================================================
// ScreenPaint — fragment shader da SIMULACAO de fluido/tinta (curl noise)
// Extraído verbatim de raw/hoisted.js (frag$g). #ifdef USE_NOISE = curl noise.
// Roda em ping-pong em RT de 1/4 de resolucao. Saida: .xy=velocidade(0.5),
// .z/.w=densidade/peso. Injeta um "pincel" (u_drawFrom->u_drawTo).
// ============================================================================
#define GLSLIFY 1
